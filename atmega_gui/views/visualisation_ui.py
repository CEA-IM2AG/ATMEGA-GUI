...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radio_ResCourant.setText(_translate("Dialog", "Résultat courant"))
        self.radio_ResEnreg.setText(_translate("Dialog", "Résultat enregistré"))
        self.btn_ChargeIndx.setText(_translate("Dialog", "Charger index"))
        self.radio_Diff.setText(_translate("Dialog", "Différentielle"))
        self.radio_Incre.setText(_translate("Dialog", "Incrémentale"))
